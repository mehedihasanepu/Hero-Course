...
const Carts = ({ carts, totalCreditHour, remaining, totalPrices }) => {
    return (
        <div className="mt-10">
            <div  >
                ...
                <h5 className="text-xl font-semibold py-4 border-b-2 border-gray-300">Total Price : {totalPrices} USD </h5>
            </div>
        </div>
    );
};
